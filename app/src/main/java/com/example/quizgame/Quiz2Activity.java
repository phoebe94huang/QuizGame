...
public class Quiz2Activity extends AppCompatActivity {
    ...
    private void checkAnswer() {
        ...
        if(answer2.isChecked()) { // Correct answer
            score += 1; // Add 1
            updateScore(score);
            Toast.makeText(Quiz2Activity.this, "That's correct! Great job! +1", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(Quiz2Activity.this, Quiz3Activity.class); // Goes to next question
            intent.putExtra("score", score); // pass amount earned
            startActivity(intent);
            finish();
        } else { // Wrong answer
            updateScore(score);
            Toast.makeText(Quiz2Activity.this, "That's incorrect. The correct answer is: Barack Obama", Toast.LENGTH_SHORT).show();
