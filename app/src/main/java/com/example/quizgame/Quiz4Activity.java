...
public class Quiz4Activity extends AppCompatActivity {
    ...
    private void checkAnswer(){
        ...
        if(answer1.isChecked() && answer2.isChecked() && answer4.isChecked()) {
            score++;
            updateScore(score);
            Toast.makeText(Quiz4Activity.this, "Correct! Great job! :)", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(Quiz4Activity.this, Quiz5Activity.class);
            intent.putExtra("score", score); // pass the current score to next question
            startActivity(intent);
            finish();
        } else {
            Toast.makeText(Quiz4Activity.this, "Incorrect! The answers are: North Carolina" +
